				...
				<div class="tab-pane" id="tab-hl7specs" v-bind:class="{ active: detailsTab=='tab-hl7specs' }">
					<div class="row-fluid">
						<div class="span6">
							...
							<table class="table table-bordered table-striped table-condensed table-sti margin-left-0" v-show="selectedCsType !== 'VALUE_SET'">
								<tr>
									<td class="td-label-detail"><strong>{{ $t("message.labelCode", lang) }}</strong></td>
									<td>{{pageComponents.detailObj.resourceName }}</td>
								</tr>
								<tr>
									<td class="td-label-detail"><strong>{{ $t("message.labelOid", lang) }}</strong></td>
